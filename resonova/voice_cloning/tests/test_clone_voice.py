"""
Unit tests for resonova.voice_cloning.clone_voice
===============================================
Run with:  pytest resonova/voice_cloning/tests/test_clone_voice.py -v
...
from resonova.exceptions import VoiceCloningError
...
class TestCloneVoice:
    ...
    def test_creates_output_wav_file(
        ...
        with patch("resonova.voice_cloning.clone_voice._load_tts_model", return_value=mock_tts_model):
    ...
    def test_tts_runtime_error_raises_voice_cloning_error(
        ...
        with patch("resonova.voice_cloning.clone_voice._load_tts_model", return_value=mock_model):
            from resonova.voice_cloning.clone_voice import clone_voice
...
class TestGetAudioDuration:
    ...
    def test_correct_duration_for_known_wav(self, tmp_path: Path):
        ...
        from resonova.voice_cloning.clone_voice import _get_audio_duration
