"""
Unit tests for mimi.translation.translate
===========================================
Run with:  pytest mimi/translation/tests/test_translate.py -v
...
class TestTranslate:
    ...
    def test_returns_non_empty_string(self, mock_indictrans2):
        ...
        with patch("mimi.translation.translate._load_model", return_value=mock_indictrans2), \
...
class TestGetSupportedLanguages:
    ...
    def test_returns_set(self):
        from mimi.translation.translate import get_supported_languages
    ...
    def test_returns_copy(self):
        ...
        from mimi.translation.translate import get_supported_languages, SUPPORTED_LANGS
        langs = get_supported_languages()
        langs.add("FAKE_LANG")
