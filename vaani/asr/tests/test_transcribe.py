"""
Unit tests for vaani.asr.transcribe
====================================
Run with:  pytest vaani/asr/tests/test_transcribe.py -v
...
from vaani.exceptions import TranscriptionError
...
class TestTranscribe:
    ...
    def test_returns_non_empty_string(self, silent_wav: Path, mock_whisper_model):
        ...
        with patch("vaani.asr.transcribe._load_model", return_value=mock_whisper_model):
    ...
    def test_empty_transcript_raises_transcription_error(self, silent_wav: Path):
        ...
        with patch("vaani.asr.transcribe._load_model", return_value=mock_model):
            from vaani.asr.transcribe import transcribe
    ...
    def test_model_size_param_passed_to_load_model(self, silent_wav: Path, mock_whisper_model):
        ...
        with patch("vaani.asr.transcribe._load_model", return_value=mock_whisper_model) as mock_load:
            from vaani.asr.transcribe import transcribe
...
class TestTranscribeWithTimestamps:
    ...
    def test_returns_list(self, silent_wav: Path, mock_whisper_model):
        ...
        with patch("vaani.asr.transcribe._load_model", return_value=mock_whisper_model):
            from vaani.asr.transcribe import transcribe_with_timestamps
