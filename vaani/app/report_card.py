"""
Vaani — Emotion Report Card Generator
======================================
...
def generate_report_card(
    ...
    """
    Generate the Vaani Emotion Analysis Report Card as a PIL Image.
    """
    ...
    # ── 1. HEADER ─────────────────────────────────────────────────────────────
    ax_base.text(4, 94, "VAANI - EMOTION DUBBING", color=PURPLE, fontsize=12, fontweight='bold', alpha=0.8)
