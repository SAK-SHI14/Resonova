"""
Vaani — Shared logging configuration.

Every module in the Vaani pipeline imports get_logger() from here to ensure
...
def get_logger(name: Optional[str] = None) -> logging.Logger:
    """
    Return a named logger with Vaani's standard formatting applied.
    ...
    return logging.getLogger(name or "vaani")
