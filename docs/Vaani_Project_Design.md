# VAANI — Emotion-Preserving AI Dubbing & Voice-Cloned Translation
...
Build **Vaani** — an emotion-preserving AI dubbing pipeline:
...
- **3-4 resume bullets**, e.g.:
  - *"Built Vaani, an emotion-preserving AI dubbing pipeline combining Whisper, IndicTrans2, XTTS voice cloning, and Wav2Lip lip-sync, achieving X% speaker-similarity and Y% emotion-preservation agreement on a self-recorded evaluation set."*
