"""
Unit tests for babel.translation.translate
===========================================
Run with:  pytest babel/translation/tests/test_translate.py -v
...
class TestTranslate:
    ...
    def test_returns_non_empty_string(self, mock_indictrans2):
        ...
        with patch("babel.translation.translate._load_model", return_value=mock_indictrans2), \
...
class TestGetSupportedLanguages:
    ...
    def test_returns_set(self):
        from babel.translation.translate import get_supported_languages
    ...
    def test_returns_copy(self):
        ...
        from babel.translation.translate import get_supported_languages, SUPPORTED_LANGS
        langs = get_supported_languages()
        langs.add("FAKE_LANG")
