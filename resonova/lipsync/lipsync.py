...
Integration Pattern:
  ...
  while keeping Resonova's own dependency tree clean.
...
from resonova.exceptions import LipSyncError
...
def lipsync(
    ...
    # directly (which would cause dependency conflicts with Resonova's own imports).
