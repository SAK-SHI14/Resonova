...
Integration Pattern:
  ...
  while keeping Vaani's own dependency tree clean.
...
from vaani.exceptions import LipSyncError
...
def lipsync(
    ...
    # directly (which would cause dependency conflicts with Vaani's own imports).
