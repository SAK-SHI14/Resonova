...
resonova.app.launch
================
Entry point for launching the Resonova Gradio app locally or via Docker.

Usage:
    python -m resonova.app.launch           # local run
...
def main() -> None:
    ...
    logger.info("=" * 60)
    logger.info("Resonova — Starting Gradio application")
    logger.info("=" * 60)
